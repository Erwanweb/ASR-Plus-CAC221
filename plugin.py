...
class BasePlugin:
    ...
    def __init__(self):
        ...
        self.overheatvalue = 1
                ...
                Domoticz.Debug("AUTO HEAT LOG -- Room Temp: {:.2f}, Thermostat Setpoint: {:.2f}, Initial Delta: {:.2f}, Adjusted Overheatvalue: {}, Final Setpoint: {}".format(
                    self.intemp,
                    float(Devices[5].sValue),
                    self.intemp - self.setpoint,
                    self.overheatvalue,
                    self.setpoint
                ))
        self.undervalue = 1
