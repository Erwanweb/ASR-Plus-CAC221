...
# MODE AUTO COOL ------------------------------------------------------------------------------------
                ...
                if self.intemp <= (self.setpoint + 0.1):
                    if self.intemp < (self.setpoint - 1.0):
                        self.undervalue = round((self.setpoint - self.intemp) + 4)
                    elif self.intemp < (self.setpoint - 0.5):
                        self.undervalue = math.ceil((self.setpoint - self.intemp) + 3)
                    elif self.intemp < (self.setpoint - 0.3):
                        self.undervalue = math.ceil((self.setpoint - self.intemp) + 2)
                    elif self.intemp < self.setpoint:
                        self.undervalue = math.ceil(max(0, (self.setpoint - self.intemp) * 2))
                    else:
                        self.undervalue = 1
                else:
                    self.undervalue = round((self.setpoint - self.intemp), 1)
